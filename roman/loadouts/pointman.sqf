...
for "_i" from 1 to 5 do {player addItemToVest "6Rnd_00_Buckshot_Magazine";};
for "_i" from 1 to 5 do {player addItemToVest "6Rnd_Slug_Magazine";};
...
player addWeapon "bnae_m97_virtual";
